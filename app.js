...
function buildPrompt(style, extra) {
  return `Use the uploaded selfie as the only identity reference. Preserve identity strongly and keep the face fully recognizable. Make the same person look exceptionally attractive, photogenic and flattering, suitable for a premium profile photo. ${style.prompt}. The person should look realistically 5 to 10 years younger than in the original selfie, while remaining clearly the same real person. Smooth or remove wrinkles, skin creases, blemishes, under-eye darkness, uneven texture, tiredness and visible skin marks. Do not add age, do not add wrinkles, do not add harsh expression lines, and do not make the person older. Improve facial harmony, symmetry, skin quality, posture and lighting in a believable way. Teeth should look clean and naturally white when smiling. Hair should look freshly styled, polished and salon-quality, while still believable for the person. Preserve bone structure, nose, mouth, eyes and overall identity. Keep everything realistic, elegant and flattering, with premium retouching but without looking fake or overprocessed. No plastic skin, no fake face, no changing ethnicity, no changing gender, no extra people, no duplicate face, no distorted hands. ${extra ? `Extra guidance: ${extra}.` : ''}`;
}
